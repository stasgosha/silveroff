						...
						<div class="footer-block">
							<div class="footer-nav gray">
								<ul>
									...
									<li><a href="#">Возврат товара и обмен</a></li>
									<li><a href="#">Отправка по России</a></li>
						...
						<div class="footer-block">
							...
							<ul class="contacts-list">
								...
								<li>
									...
									<div class="item-content">
										<a href="mailto:info@silveroff.ru">Обратная связь</a>
									</div>
								</li>
								<li>
									<div class="item-icon">
									...
									<div class="item-content">
										<p>Москва, ул. Касаткина 3а стр.7</p>
									</div>
								</li>
							</ul>
						</div>
						<div class="footer-block">
							<h4 class="footer-caption text-center">Отзывы о нас</h4>
